    ...
    <section class="content-section" id="portfolio">
      <div class="container">
        <div class="content-section-heading text-center">
          <h3 class="text-secondary mb-0">Fresh & Homemade</h3>
            ...
            <a class="portfolio-item" href="#">
              <span class="caption">
                <span class="caption-content">
                  <h2>Apero !</h2>
                  <p class="mb-0">Faites vous plaisir et choisissez un apéritif surpenant pour vos amis !</p>
                </span>
              </span>
          ...
          <div class="col-lg-6">
            <a class="portfolio-item" href="#">
              <span class="caption">
                <span class="caption-content">
                  <h2>Entrée</h2>
                  <p class="mb-0">Vegan, végétarien, amoureux de la viande ? Vous y trouverez votre exigence !</p>
                </span>
              </span>
          ...
          <div class="col-lg-6">
            <a class="portfolio-item" href="#">
              <span class="caption">
                <span class="caption-content">
                  <h2>Plat</h2>
                  <p class="mb-0">Pour tous les goûts, de healthy à généreux !</p>
                </span>
              </span>
          ...
          <div class="col-lg-6">
            <a class="portfolio-item" href="#">
              <span class="caption">
                <span class="caption-content">
                  <h2>Dessert</h2>
                  <p class="mb-0">Nos desserts sont faits-maison ou commandés dans les meilleures patisseries de paris.</p>
                </span>
              </span>
